...
:root {
  ...
  --font-season-mix:
    "Season Mix", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,
    "Segoe UI", Roboto, sans-serif;
  --font-soehne:
    "Soehne", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,
    "Segoe UI", Roboto, sans-serif;
  --font-abc-diatype:
    "Abc Diatype", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,
    "Segoe UI", Roboto, sans-serif;
  --font-founders-grotesk-mono:
    "Founders Grotesk Mono", ui-monospace, SFMono-Regular, Menlo, Monaco,
    Consolas, monospace;
